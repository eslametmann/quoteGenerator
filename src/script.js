...
function App(){
  ...
  return (
  <div id="quote-box" className="container col-7 p-4 rounded ">
      <h3 id="text">{currentQuote.quote}</h3>
      <p id="author" className="row ">
        <div className="col-6"></div>
        <i className="col">{currentQuote.author}</i>
      </p>
      <div className="text-center">
      <button id="new-quote" className="btn btn-danger text-center" onClick={newQuote}>new quote</button>
      </div>
      <div>
      <a href="twitter.com/intent/tweet" id="tweet-quote"></a>
    <i class="fa-brands fa-twitter fa-2xl" style={{"color": "red"}}></i>    
      </div>
  </div>
  )
}
